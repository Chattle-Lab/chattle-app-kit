...
setInterval(() => {
    ...
    if (files.length) {
        ...
        try {
            let cmd = "cd "+rootDir+" & mkdir .build & node node_modules/react-native/local-cli/cli.js bundle --platform android --dev true --entry-file src/App.js --config node_modules/chattle-app-kit/.moduleserializer.js --bundle-output .build/dev.bundle --assets-dest .build/"
